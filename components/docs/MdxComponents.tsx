...
export const components: MDXComponents = {
  ...
  h1: (p) => <h1 className="text-3xl font-bold text-white mb-2 mt-0 tracking-tight" {...p} />,
  h2: (p) => <h2 className="text-xl font-semibold text-white mt-10 mb-3 pb-2 border-b border-[#111] scroll-mt-20" {...p} />,
  h3: (p) => <h3 className="text-base font-semibold text-white mt-6 mb-2 scroll-mt-20" {...p} />,
  h4: (p) => <h4 className="text-sm font-semibold text-[#ccc] mt-4 mb-1" {...p} />,
  p: (p) => <p className="text-[#888] text-sm leading-7 mb-4" {...p} />,
  a: (p) => <a className="text-[#0070f3] hover:underline underline-offset-2" {...p} />,
  strong: (p) => <strong className="text-white font-semibold" {...p} />,
  em: (p) => <em className="text-[#aaa] italic" {...p} />,
  ul: (p) => <ul className="text-[#888] text-sm leading-7 mb-4 pl-5 space-y-1 list-disc marker:text-[#444]" {...p} />,
  ol: (p) => <ol className="text-[#888] text-sm leading-7 mb-4 pl-5 space-y-1 list-decimal marker:text-[#444]" {...p} />,
  li: (p) => <li className="leading-7" {...p} />,
  blockquote: (p) => <blockquote className="border-l-2 border-[#0070f3] pl-4 text-[#666] italic text-sm my-4" {...p} />,
